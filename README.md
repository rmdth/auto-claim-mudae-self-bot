...
- Last hour (seconds) auto claim based on given time.
- Adjust claim kakera cost for characters your characters with 10+ keys.
...
- After claiming something check if theres more actual wishes to claim with rt.
